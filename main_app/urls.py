...
urlpatterns = [
    ...
    path("subject_fee/edit/<int:subjectfee_id>", hod_views.edit_subject_fee, name='edit_subject_fee'),
    path("subject_fee/delete/<int:subjectfee_id>",
         hod_views.delete_subject_fee, name='delete_subject_fee'),
